...
if("TRUE" STREQUAL "TRUE")
  set(libconcorde_tsp_solver_SOURCE_PREFIX /home/daryl/ttb_ws/src/ipa_tsp_solvers/libconcorde_tsp_solver)
  set(libconcorde_tsp_solver_DEVEL_PREFIX /home/daryl/ttb_ws/devel/.private/libconcorde_tsp_solver)
  ...
  set(libconcorde_tsp_solver_INSTALL_PREFIX /home/daryl/ttb_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'libconcorde_tsp_solver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/daryl/ttb_ws/src/ipa_tsp_solvers/libconcorde_tsp_solver/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT libconcorde_tsp_solver_NUM_DUMMY_TARGETS)
      set(libconcorde_tsp_solver_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::libconcorde_tsp_solver::wrapped-linker-option${libconcorde_tsp_solver_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR libconcorde_tsp_solver_NUM_DUMMY_TARGETS "${libconcorde_tsp_solver_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::libconcorde_tsp_solver::wrapped-linker-option${libconcorde_tsp_solver_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND libconcorde_tsp_solver_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/daryl/ttb_ws/devel/.private/libconcorde_tsp_solver/lib;/home/daryl/ttb_ws/devel/lib;/opt/ros/melodic/lib)
