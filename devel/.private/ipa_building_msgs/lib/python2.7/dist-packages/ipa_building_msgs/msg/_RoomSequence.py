...
"""autogenerated by genpy from ipa_building_msgs/RoomSequence.msg. Do not edit."""
import codecs
import sys
...
class RoomSequence(genpy.Message):
  ...
  _type = "ipa_building_msgs/RoomSequence"
...
float32 z"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sI'%length
      buff.write(struct.Struct(pattern).pack(*self.room_indices))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.room_indices = s.unpack(str[start:end])
      _x = self
      start = end
      end += 24
