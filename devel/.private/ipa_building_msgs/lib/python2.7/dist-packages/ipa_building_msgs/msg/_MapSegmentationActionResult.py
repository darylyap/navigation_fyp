...
"""autogenerated by genpy from ipa_building_msgs/MapSegmentationActionResult.msg. Do not edit."""
import codecs
import sys
...
class MapSegmentationActionResult(genpy.Message):
  ...
  _type = "ipa_building_msgs/MapSegmentationActionResult"
...
float32 z"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','ipa_building_msgs/MapSegmentationResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = ipa_building_msgs.msg.MapSegmentationResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = ipa_building_msgs.msg.MapSegmentationResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.result.segmented_map.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.result.segmented_map.encoding = str[start:end].decode('utf-8', 'rosmsg')
      else:
