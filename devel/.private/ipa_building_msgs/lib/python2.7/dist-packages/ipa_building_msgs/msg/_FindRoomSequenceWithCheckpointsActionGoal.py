...
"""autogenerated by genpy from ipa_building_msgs/FindRoomSequenceWithCheckpointsActionGoal.msg. Do not edit."""
import codecs
import sys
...
class FindRoomSequenceWithCheckpointsActionGoal(genpy.Message):
  _md5sum = "ccd3b5d97e2fb08a9d31664a441aed53"
  _type = "ipa_building_msgs/FindRoomSequenceWithCheckpointsActionGoal"
...
float32 z"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','ipa_building_msgs/FindRoomSequenceWithCheckpointsGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FindRoomSequenceWithCheckpointsActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = ipa_building_msgs.msg.FindRoomSequenceWithCheckpointsGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = ipa_building_msgs.msg.FindRoomSequenceWithCheckpointsGoal()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_f7d().pack(_x.goal.map_resolution, _x.goal.map_origin.position.x, _x.goal.map_origin.position.y, _x.goal.map_origin.position.z, _x.goal.map_origin.orientation.x, _x.goal.map_origin.orientation.y, _x.goal.map_origin.orientation.z, _x.goal.map_origin.orientation.w))
      length = len(self.goal.room_information_in_pixel)
      buff.write(_struct_I.pack(length))
      for val1 in self.goal.room_information_in_pixel:
        ...
        buff.write(_get_struct_3f().pack(_x.x, _x.y, _x.z))
      _x = self
      buff.write(_get_struct_8d().pack(_x.goal.robot_radius, _x.goal.robot_start_coordinate.position.x, _x.goal.robot_start_coordinate.position.y, _x.goal.robot_start_coordinate.position.z, _x.goal.robot_start_coordinate.orientation.x, _x.goal.robot_start_coordinate.orientation.y, _x.goal.robot_start_coordinate.orientation.z, _x.goal.robot_start_coordinate.orientation.w))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.map_resolution, _x.goal.map_origin.position.x, _x.goal.map_origin.position.y, _x.goal.map_origin.position.z, _x.goal.map_origin.orientation.x, _x.goal.map_origin.orientation.y, _x.goal.map_origin.orientation.z, _x.goal.map_origin.orientation.w,) = _get_struct_f7d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.goal.room_information_in_pixel = []
      for i in range(0, length):
        val1 = ipa_building_msgs.msg.RoomInformation()
        ...
        (_x.x, _x.y, _x.z,) = _get_struct_3f().unpack(str[start:end])
        self.goal.room_information_in_pixel.append(val1)
      _x = self
      start = end
      end += 64
      (_x.goal.robot_radius, _x.goal.robot_start_coordinate.position.x, _x.goal.robot_start_coordinate.position.y, _x.goal.robot_start_coordinate.position.z, _x.goal.robot_start_coordinate.orientation.x, _x.goal.robot_start_coordinate.orientation.y, _x.goal.robot_start_coordinate.orientation.z, _x.goal.robot_start_coordinate.orientation.w,) = _get_struct_8d().unpack(str[start:end])
      return self
