...
"""autogenerated by genpy from ipa_building_msgs/RoomExplorationAction.msg. Do not edit."""
import codecs
import sys
...
class RoomExplorationAction(genpy.Message):
  _md5sum = "73208c74aa90769aaf62b3c550c1fa13"
  _type = "ipa_building_msgs/RoomExplorationAction"
...
"""
  ...
  _slot_types = ['ipa_building_msgs/RoomExplorationActionGoal','ipa_building_msgs/RoomExplorationActionResult','ipa_building_msgs/RoomExplorationActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = ipa_building_msgs.msg.RoomExplorationActionGoal()
      if self.action_result is None:
        self.action_result = ipa_building_msgs.msg.RoomExplorationActionResult()
      if self.action_feedback is None:
        self.action_feedback = ipa_building_msgs.msg.RoomExplorationActionFeedback()
    else:
      self.action_goal = ipa_building_msgs.msg.RoomExplorationActionGoal()
      self.action_result = ipa_building_msgs.msg.RoomExplorationActionResult()
      self.action_feedback = ipa_building_msgs.msg.RoomExplorationActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_3f3di3I().pack(_x.action_goal.goal.field_of_view_origin.x, _x.action_goal.goal.field_of_view_origin.y, _x.action_goal.goal.field_of_view_origin.z, _x.action_goal.goal.starting_position.x, _x.action_goal.goal.starting_position.y, _x.action_goal.goal.starting_position.theta, _x.action_goal.goal.planning_mode, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.input_map.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.action_goal.goal.input_map.encoding = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      (_x.action_goal.goal.field_of_view_origin.x, _x.action_goal.goal.field_of_view_origin.y, _x.action_goal.goal.field_of_view_origin.z, _x.action_goal.goal.starting_position.x, _x.action_goal.goal.starting_position.y, _x.action_goal.goal.starting_position.theta, _x.action_goal.goal.planning_mode, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_3f3di3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
...
def _get_struct_3f():
    ...
    return _struct_3f
_struct_3f3di3I = None
def _get_struct_3f3di3I():
    global _struct_3f3di3I
    if _struct_3f3di3I is None:
        _struct_3f3di3I = struct.Struct("<3f3di3I")
    return _struct_3f3di3I
_struct_4d = None
def _get_struct_4d():
    global _struct_4d
