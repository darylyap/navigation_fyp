...
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(RoomSegmentationConfig::AbstractParamDescriptionConstPtr(new RoomSegmentationConfig::ParamDescription<int>("room_segmentation_algorithm", "int", 0, "Segmentation method", "{'enum_description': 'Segmentation algorithm', 'enum': [{'srcline': 8, 'description': 'Use the morphological segmentation algorithm.', 'srcfile': '/home/daryl/ttb_ws/src/autopnp/ipa_room_segmentation/cfg/RoomSegmentation.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'MorphologicalSegmentation'}, {'srcline': 9, 'description': 'Use the distance segmentation algorithm.', 'srcfile': '/home/daryl/ttb_ws/src/autopnp/ipa_room_segmentation/cfg/RoomSegmentation.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'DistanceSegmentation'}, {'srcline': 10, 'description': 'Use the Voronoi segmentation algorithm.', 'srcfile': '/home/daryl/ttb_ws/src/autopnp/ipa_room_segmentation/cfg/RoomSegmentation.cfg', 'cconsttype': 'const int', 'value': 3, 'ctype': 'int', 'type': 'int', 'name': 'VoronoiSegmentation'}, {'srcline': 11, 'description': 'Use the semantic/feature-based segmentation algorithm.', 'srcfile': '/home/daryl/ttb_ws/src/autopnp/ipa_room_segmentation/cfg/RoomSegmentation.cfg', 'cconsttype': 'const int', 'value': 4, 'ctype': 'int', 'type': 'int', 'name': 'SemanticSegmentation'}, {'srcline': 12, 'description': 'Use the voronoi-random-field segmentation algorithm.', 'srcfile': '/home/daryl/ttb_ws/src/autopnp/ipa_room_segmentation/cfg/RoomSegmentation.cfg', 'cconsttype': 'const int', 'value': 5, 'ctype': 'int', 'type': 'int', 'name': 'RandomFieldSegmentation'}, {'srcline': 13, 'description': 'Use the pass through segmentation algorithm.', 'srcfile': '/home/daryl/ttb_ws/src/autopnp/ipa_room_segmentation/cfg/RoomSegmentation.cfg', 'cconsttype': 'const int', 'value': 99, 'ctype': 'int', 'type': 'int', 'name': 'PassThroughSegmentation'}]}", &RoomSegmentationConfig::room_segmentation_algorithm)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 8 "/home/daryl/ttb_ws/src/autopnp/ipa_room_segmentation/cfg/RoomSegmentation.cfg"
      const int RoomSegmentation_MorphologicalSegmentation = 1;
//#line 9 "/home/daryl/ttb_ws/src/autopnp/ipa_room_segmentation/cfg/RoomSegmentation.cfg"
      const int RoomSegmentation_DistanceSegmentation = 2;
//#line 10 "/home/daryl/ttb_ws/src/autopnp/ipa_room_segmentation/cfg/RoomSegmentation.cfg"
      const int RoomSegmentation_VoronoiSegmentation = 3;
//#line 11 "/home/daryl/ttb_ws/src/autopnp/ipa_room_segmentation/cfg/RoomSegmentation.cfg"
      const int RoomSegmentation_SemanticSegmentation = 4;
//#line 12 "/home/daryl/ttb_ws/src/autopnp/ipa_room_segmentation/cfg/RoomSegmentation.cfg"
      const int RoomSegmentation_RandomFieldSegmentation = 5;
//#line 13 "/home/daryl/ttb_ws/src/autopnp/ipa_room_segmentation/cfg/RoomSegmentation.cfg"
