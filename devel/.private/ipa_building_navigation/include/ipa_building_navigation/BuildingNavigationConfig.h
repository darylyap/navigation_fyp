...
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(BuildingNavigationConfig::AbstractParamDescriptionConstPtr(new BuildingNavigationConfig::ParamDescription<int>("tsp_solver", "int", 0, "TSP solver", "{'enum_description': 'TSP solver', 'enum': [{'srcline': 9, 'description': 'Use the nearest neighbor TSP algorithm.', 'srcfile': '/home/daryl/ttb_ws/src/autopnp/ipa_building_navigation/cfg/BuildingNavigation.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'NearestNeighbor'}, {'srcline': 10, 'description': 'Use the genetic TSP algorithm.', 'srcfile': '/home/daryl/ttb_ws/src/autopnp/ipa_building_navigation/cfg/BuildingNavigation.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'GeneticSolver'}, {'srcline': 11, 'description': 'Use the Concorde TSP algorithm.', 'srcfile': '/home/daryl/ttb_ws/src/autopnp/ipa_building_navigation/cfg/BuildingNavigation.cfg', 'cconsttype': 'const int', 'value': 3, 'ctype': 'int', 'type': 'int', 'name': 'ConcordeSolver'}]}", &BuildingNavigationConfig::tsp_solver)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(BuildingNavigationConfig::AbstractParamDescriptionConstPtr(new BuildingNavigationConfig::ParamDescription<int>("problem_setting", "int", 0, "Problem setting of the sequence planning problem", "{'enum_description': 'Problem setting of the sequence planning problem', 'enum': [{'srcline': 16, 'description': 'Plan the optimal order of a simple set of locations.', 'srcfile': '/home/daryl/ttb_ws/src/autopnp/ipa_building_navigation/cfg/BuildingNavigation.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'SimpleOrderPlanning'}, {'srcline': 17, 'description': 'Two-stage planning that creates local cliques of locations (= checkpoints) and determines the optimal order through the members of each clique as well as the optimal order through the cliques.', 'srcfile': '/home/daryl/ttb_ws/src/autopnp/ipa_building_navigation/cfg/BuildingNavigation.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'CheckpointBasedPlanning'}]}", &BuildingNavigationConfig::problem_setting)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(BuildingNavigationConfig::AbstractParamDescriptionConstPtr(new BuildingNavigationConfig::ParamDescription<int>("problem_setting", "int", 0, "Problem setting of the sequence planning problem", "{'enum_description': 'Problem setting of the sequence planning problem', 'enum': [{'srcline': 16, 'description': 'Plan the optimal order of a simple set of locations.', 'srcfile': '/home/daryl/ttb_ws/src/autopnp/ipa_building_navigation/cfg/BuildingNavigation.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'SimpleOrderPlanning'}, {'srcline': 17, 'description': 'Two-stage planning that creates local cliques of locations (= checkpoints) and determines the optimal order through the members of each clique as well as the optimal order through the cliques.', 'srcfile': '/home/daryl/ttb_ws/src/autopnp/ipa_building_navigation/cfg/BuildingNavigation.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'CheckpointBasedPlanning'}]}", &BuildingNavigationConfig::problem_setting)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(BuildingNavigationConfig::AbstractParamDescriptionConstPtr(new BuildingNavigationConfig::ParamDescription<int>("planning_method", "int", 0, "Trolley placement method (only applies to CheckpointBasedPlanning problem)", "{'enum_description': 'Trolley placement method (only applies to CheckpointBasedPlanning problem)', 'enum': [{'srcline': 23, 'description': 'Drag the trolley if it is too far away from next room.', 'srcfile': '/home/daryl/ttb_ws/src/autopnp/ipa_building_navigation/cfg/BuildingNavigation.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'DragTrolleyWhenNecessary'}, {'srcline': 24, 'description': 'Put rooms together in groups and calculate a corresponding trolley positions.', 'srcfile': '/home/daryl/ttb_ws/src/autopnp/ipa_building_navigation/cfg/BuildingNavigation.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'PrecomputeRoomGroupsAndCorrespondingTrolleyPosition'}]}", &BuildingNavigationConfig::planning_method)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(BuildingNavigationConfig::AbstractParamDescriptionConstPtr(new BuildingNavigationConfig::ParamDescription<int>("planning_method", "int", 0, "Trolley placement method (only applies to CheckpointBasedPlanning problem)", "{'enum_description': 'Trolley placement method (only applies to CheckpointBasedPlanning problem)', 'enum': [{'srcline': 23, 'description': 'Drag the trolley if it is too far away from next room.', 'srcfile': '/home/daryl/ttb_ws/src/autopnp/ipa_building_navigation/cfg/BuildingNavigation.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'DragTrolleyWhenNecessary'}, {'srcline': 24, 'description': 'Put rooms together in groups and calculate a corresponding trolley positions.', 'srcfile': '/home/daryl/ttb_ws/src/autopnp/ipa_building_navigation/cfg/BuildingNavigation.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'PrecomputeRoomGroupsAndCorrespondingTrolleyPosition'}]}", &BuildingNavigationConfig::planning_method)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 9 "/home/daryl/ttb_ws/src/autopnp/ipa_building_navigation/cfg/BuildingNavigation.cfg"
      const int BuildingNavigation_NearestNeighbor = 1;
//#line 10 "/home/daryl/ttb_ws/src/autopnp/ipa_building_navigation/cfg/BuildingNavigation.cfg"
      const int BuildingNavigation_GeneticSolver = 2;
//#line 11 "/home/daryl/ttb_ws/src/autopnp/ipa_building_navigation/cfg/BuildingNavigation.cfg"
      const int BuildingNavigation_ConcordeSolver = 3;
//#line 16 "/home/daryl/ttb_ws/src/autopnp/ipa_building_navigation/cfg/BuildingNavigation.cfg"
      const int BuildingNavigation_SimpleOrderPlanning = 1;
//#line 17 "/home/daryl/ttb_ws/src/autopnp/ipa_building_navigation/cfg/BuildingNavigation.cfg"
      const int BuildingNavigation_CheckpointBasedPlanning = 2;
//#line 23 "/home/daryl/ttb_ws/src/autopnp/ipa_building_navigation/cfg/BuildingNavigation.cfg"
      const int BuildingNavigation_DragTrolleyWhenNecessary = 1;
//#line 24 "/home/daryl/ttb_ws/src/autopnp/ipa_building_navigation/cfg/BuildingNavigation.cfg"
